    ...
    <div class="header-container">
        ...
        <style>
            ...
            .slider {
                max-width: 100%;
                width: 100%;
                height: 1080px; /* Set height for the slider */
                margin: 20px auto;
                position: relative;
                overflow: hidden;
                background-color: #000;
    ...
    <body>
        ...
        <section id="driveway-patio">
            ...
            <p>Remove ingrained dirt, moss, algae, lichen, and black spots with our professional cleaning services.<br /><br />
                We use softwashing and low-pressure cleaning techniques to ensure your surfaces are thoroughly cleaned without damage.<br /><br />
            </p>
        ...
        <section id="gutter-cleaning">
            ...
            <p>Prevent expensive repairs caused by blockages, leaks, and debris.<br /><br />
                ...
                We also offer a full gutter wash, including soffits and fascias.<br /><br />
            </p>
